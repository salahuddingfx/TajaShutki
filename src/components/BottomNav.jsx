          ...
          return (
            ...
            >
              <div className={clsx(
                ...
                isActive && "bg-emerald-600/5"
              )}>
                <Icon size={18} className={isActive ? "fill-emerald-600/10" : ""} />
              </div>
              
              {item.badge > 0 && (
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-emerald-600 text-white text-[8px] font-black flex items-center justify-center rounded-full border-2 border-white">
                  {item.badge}
                </span>
              )}
